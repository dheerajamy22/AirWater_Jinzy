...
class Team_Ticket_Approved extends StatefulWidget {
  const Team_Ticket_Approved({Key? key}) : super(key: key);

  @override
  _Team_Ticket_ApprovedState createState() => _Team_Ticket_ApprovedState();
}

class _Team_Ticket_ApprovedState extends State<Team_Ticket_Approved> {
  @override
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  border:
                                      Border.all(color: MyColor.green_color),
