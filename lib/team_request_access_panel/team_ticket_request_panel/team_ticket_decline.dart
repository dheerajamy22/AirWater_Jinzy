...
class Team_Ticket_Decline extends StatefulWidget {
  const Team_Ticket_Decline({Key? key}) : super(key: key);

  @override
 _Team_Ticket_DeclineState createState() => _Team_Ticket_DeclineState();
}

class _Team_Ticket_DeclineState extends State<Team_Ticket_Decline> {
  @override
