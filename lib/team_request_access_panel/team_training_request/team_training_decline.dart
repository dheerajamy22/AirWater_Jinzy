...
import 'package:demo/team_request_access_panel/team_training_request/models/team_training_request_model.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:http/http.dart'as http;
import 'dart:convert';
import 'package:flutter_svg/flutter_svg.dart';
class Team_Training_Decline_Request extends StatefulWidget {
  const Team_Training_Decline_Request({Key? key}) : super(key: key);

  @override
  _Team_Training_Decline_RequestState createState() =>
      _Team_Training_Decline_RequestState();
}

class _Team_Training_Decline_RequestState
    extends State<Team_Training_Decline_Request> {
