...
class Team_Travel_Requested_Expenses extends StatefulWidget {
  const Team_Travel_Requested_Expenses({Key? key}) : super(key: key);

  @override
  _Team_Travel_Requested_ExpensesState createState() =>
      _Team_Travel_Requested_ExpensesState();
}

class _Team_Travel_Requested_ExpensesState
    extends State<Team_Travel_Requested_Expenses> {
  @override
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  border:
                                      Border.all(color: MyColor.mainAppColor),
