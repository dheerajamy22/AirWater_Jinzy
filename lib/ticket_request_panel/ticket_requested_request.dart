...
class Ticket_Requested_Request extends StatefulWidget {
  const Ticket_Requested_Request({Key? key}) : super(key: key);

  @override
  _Ticket_Requested_RequestState createState() =>
      _Ticket_Requested_RequestState();
}

class _Ticket_Requested_RequestState extends State<Ticket_Requested_Request> {
  @override
    ...
    Future<List<TicketModel>> getAllData() async {
      ...
      for (var data in jsonArray) {
        ...
        for (int i = 0; i < t_data.length; i++) {
          if (t_data[i].rfticket_status == 'Submited') {
