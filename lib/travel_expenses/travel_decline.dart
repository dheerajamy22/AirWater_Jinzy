...
import 'create_travel_expenses.dart';

class Travel_Decline extends StatefulWidget {


  @override
  _Travel_DeclineState createState() => _Travel_DeclineState();
}

class _Travel_DeclineState extends State<Travel_Decline> {
  ...
  Future<List<Travel_Exp_Model>> getAllTravelData() async {
    ...
    for (var travelData in jsonArray) {
      ...
      for (int i = 0; i < data.length; i++) {
        if (data[i].trav_req_status == 'Reject') {
                      ...
                      return ListView.builder(
                        // physics: NeverScrollableScrollPhysics(),
                          ...
                          itemBuilder: (context, index) {
                            print('approved print '+travel_Data[index].trav_req_status.toString());
