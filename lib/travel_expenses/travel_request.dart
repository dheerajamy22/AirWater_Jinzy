...
class Travel_Requested extends StatefulWidget {

  @override
  _Travel_RequestedState createState() => _Travel_RequestedState();
}

class _Travel_RequestedState extends State<Travel_Requested> {
...
String? user_id = pref.getString('user_id');
    ...
    for (var travelData in jsonArray) {
      ...
      for (int i = 0; i < data.length; i++) {
        if (data[i].trav_req_status == 'Submitted') {
