...
class Trip_Requested_Request extends StatefulWidget {
  const Trip_Requested_Request({Key? key}) : super(key: key);

  @override
  State<Trip_Requested_Request> createState() => _Trip_Requested_RequestState();
}

class _Trip_Requested_RequestState extends State<Trip_Requested_Request> {
  ...
  Future<List<Trip_Requested_ListModel>> getTripRequest() async {
    ...
    for (var tripData in jsonArray) {
      ...
      for (int i = 0; i < data.length; i++) {
        if(data[i].rfbt_status=='Submited'){
